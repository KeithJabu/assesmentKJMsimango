        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="failed-jobs-table" class="display table table-striped table-hover">
                        <thead>
                        <tr>
                            <th>Class name</th>
                            <th>Method</th>
...
@section('scripts')
    ...
    <script type="text/javascript">
        let response_failed = $('#failed-jobs-table').DataTable({
            serverSide: true,
            processing: true,
            searching: false,
            ajax: {
                url: "{{ route('search.datatable', AssessmentInterface::FAILED) }}",
                data: function (data) {
